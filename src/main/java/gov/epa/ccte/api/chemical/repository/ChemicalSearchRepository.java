...
public interface ChemicalSearchRepository extends JpaRepository<ChemicalSearch, Long> {
    ...
    @Query(value = """
            select s.id, s.search_group, s.search_name, s.search_value, s.modified_value, s.rank,\s
                   d.h_chem_hash_key, d.dtxsid, d.dtxcid, d.casrn, d.compound_id, d.generic_substance_id, d.preferred_name, d.active_assays,\s
                   d.cpdata_count, d.mol_formula, d.monoisotopic_mass, d.percent_assays, d.pubchem_count, d.pubmed_count, d.sources_count,\s
                   d.qc_level, d.qc_level_desc, d.stereo, d.isotope, d.multicomponent, d.total_assays, d.toxcast_select, d.pubchem_cid,\s
                   d.mol_file, d.mrv_file, d.related_substance_count, d.related_structure_count, d.mol_image, d.has_structure_image,\s
                   d.iupac_name, d.smiles, d.inchi_string, d.average_mass, d.inchikey, d.qc_notes, d.qsar_ready_smiles, d.ms_ready_smiles,\s
                   d.iris_link, d.pprtv_link, d.wikipedia_article, d.expocat_median_prediction, d.expocat, d.nhanes, d.toxval_data,\s
                   d.water_solubility_test, d.water_solubility_opera, d.viscosity_cp_cp_test_pred, d.vapor_pressure_mmhg_test_pred,
                   d.vapor_pressure_mmhg_opera_pred, d.thermal_conductivity, d.tetrahymena_pyriformis, d.surface_tension, d.soil_adsorption_coefficient,\s
                   d.oral_rat_ld50_mol, d.opera_km_days_opera_pred, d.octanol_water_partition, d.octanol_air_partition_coeff, d.melting_point_degc_test_pred,\s
                   d.melting_point_degc_opera_pred, d.hr_fathead_minnow, d.hr_diphnia_lc50, d.henrys_law_atm, d.flash_point_degc_test_pred,\s
                   d.devtox_test_pred, d.density, d.boiling_point_degc_test_pred, d.boiling_point_degc_opera_pred, d.biodegradation_half_life_days,\s
                   d.bioconcentration_factor_test_pred, d.bioconcentration_factor_opera_pred, d.atmospheric_hydroxylation_rate, d.ames_mutagenicity_test_pred,\s
                   d.pkaa_opera_pred, d.pkab_opera_pred, d.descriptor_string_tsv, d.is_markush\s
